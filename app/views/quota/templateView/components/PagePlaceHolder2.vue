...
<script lang="ts" setup>
  import { toRefs, ComputedRef, computed, CSSProperties, ref } from 'vue';
  import {
    paginationInfoType,
  ...
  import { useLayout } from './views/layoutabs';
  ...
  const pagePlaceHolder = ref<HTMLElement>();
  ...
  useLayout(pagePlaceHolder, templateList, selectedTemplateDOMList, pageSetting);
